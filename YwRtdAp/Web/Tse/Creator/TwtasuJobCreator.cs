...
namespace YwRtdAp.Web.Tse.Creator
{
    ...
    /// TWTASU
    /// url:
    /// http://www.tse.com.tw/exchangeReport/TWTASU?response=json&date=20180202&_=1517672164449
    /// by date
    /// 
    /// header:
    ///GET /exchangeReport/TWTASU?response=json&date=20180202&_=1517672164449 HTTP/1.1
    ///Host: www.tse.com.tw
    ...
    /// </summary>
    public class TwtasuJobCreator: JobCreator
    {
